			...
			success:function(json){
				...
				$.each(json, function(entryIndex, entry){
					...
					{// 검색어가 없을시 
						...
						resultHTML += "<tr>" +
										  "<td><a onClick='sendBack(\""+entry.SeodaemunPublisherPrintBiz.row.COMPANY+"\");'>"+entry.COMPANY+"</a></td>"+
					...
					{// 검색어가 있을시 
						...
						if(entry.SeodaemunPublisherPrintBiz.row.COMPANY.indexOf(searchWord) != -1){
