		...
		<div class="row banner-bottom align-items-center justify-content-center">
			<div class="col-lg-4">
				<div class="video-popup d-flex align-items-center">
					<a class="play-video video-play-button animate" href="resources/https://www.youtube.com/watch?v=KUln2DXU5VE" data-animate="zoomIn"
					 data-duration="1.5s" data-delay="0.1s">
						<span><img src="resources/img/banner/play-icon.png" alt=""></span>
					</a>
					<div class="watch">
						<h6>Watch video</h6>
				...
				<div class="banner_content">
					<div class="row d-flex align-items-center">
						<div class="col-lg-8 col-md-12">
							...
							<p>inappropriate behavior is often laughed off as âboys will be boys,â women face higher conduct standards
			...
			<div class="container">
				<div class="row align-items-center justify-content-center">
					...
					<div class="col-lg-6 offset-lg-1">
						<div class="right-img">
							<img class="img1 img-fluid" src="resources/img/food/food1.jpg" alt="">
							<img class="img2 img-fluid" src="resources/img/food/food2.png" alt="">
						</div>
					</div>
				</div>
			</div>
		...
		<div class="breakfast-area lunch-area section_gap">
			<div class="container">
				<div class="row align-items-center justify-content-center">
					<div class="col-lg-6 ">
						<div class="right-img">
							<img class="img1 img-fluid" src="resources/img/food/food3.jpg" alt="">
							<img class="img2 img-fluid" src="resources/img/food/food4.png" alt="">
						</div>
					</div>
					<div class="col-lg-5 offset-lg-1">
						<div class="left-content">
							...
							<div class="chef-title">
								<div class="thumb"><img src="resources/img/about-author.png" alt=""></div>
								<div class="c-desc">
									<h6>Marvel Maison</h6>
		...
		<div class="chef-area section_gap_top">
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-lg-6">
						<div class="left-chef">
							<img class="img-fluid" src="resources/img/chef/chef1.jpg" alt="">
						</div>
					</div>
					<div class="col-lg-5 offset-lg-1">
						<div class="left-content">
							...
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
								dolore
								magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation.</p>
							<img src="resources/img/chef/signature.png" alt="">
						</div>
					</div>
				</div>
						...
						<div class="row">
							...
							<div class="col-lg-2 col-md-5">
								<div class="single-chef-item">
									<a href="resources/img/food/food5.jpg" class="img-popup"><img src="resources/img/chef/item1.png" alt=""></a>
								</div>
							</div>
							<!-- single chef item -->
							<div class="col-lg-2 col-md-5">
								<div class="single-chef-item">
									<a href="resources/img/food/food6.jpg" class="img-popup"><img src="resources/img/chef/item2.png" alt=""></a>
								</div>
							</div>
							<!-- single chef item -->
							<div class="col-lg-2 col-md-5">
								<div class="single-chef-item">
									<a href="resources/img/food/food7.jpg" class="img-popup"><img src="resources/img/chef/item3.png" alt=""></a>
								</div>
							</div>
							<!-- single chef item -->
							<div class="col-lg-2 col-md-5">
								<div class="single-chef-item">
									<a href="resources/img/food/food8.jpg" class="img-popup"><img src="resources/img/chef/item4.png" alt=""></a>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="container-fluid no-padding">
				<div class="row owl-carousel active-food-gallery">
					...
					<div class="single-gallery-item">
						<img class="img-fluid" src="resources/img/food/food5.jpg" alt="">
					</div>
					<!-- single gallery item -->
					<div class="single-gallery-item">
						<img class="img-fluid" src="resources/img/food/food6.jpg" alt="">
					</div>
					<!-- single gallery item -->
					<div class="single-gallery-item">
						<img class="img-fluid" src="resources/img/food/food7.jpg" alt="">
					</div>
					<!-- single gallery item -->
					<div class="single-gallery-item">
						<img class="img-fluid" src="resources/img/food/food8.jpg" alt="">
					</div>
					<!-- single gallery item -->
					<div class="single-gallery-item">
						<img class="img-fluid" src="resources/img/food/food6.jpg" alt="">
						...
						<div class="owl-carousel brand-carousel">
							...
							<div class="single-brand-item d-table">
								<div class="d-table-cell">
									<img src="resources/img/brands/logo1.png" alt="">
								</div>
							</div>
							<!-- single-brand -->
							<div class="single-brand-item d-table">
								<div class="d-table-cell">
									<img src="resources/img/brands/logo2.png" alt="">
								</div>
							</div>
							<!-- single-brand -->
							<div class="single-brand-item d-table">
								<div class="d-table-cell">
									<img src="resources/img/brands/logo3.png" alt="">
								</div>
							</div>
							<!-- single-brand -->
							<div class="single-brand-item d-table">
								<div class="d-table-cell">
									<img src="resources/img/brands/logo4.png" alt="">
								</div>
							</div>
							<!-- single-brand -->
							<div class="single-brand-item d-table">
								<div class="d-table-cell">
									<img src="resources/img/brands/logo5.png" alt="">
								</div>
							</div>
							<!-- single-brand -->
							<div class="single-brand-item d-table">
