	...
	<div class="row">
		...
		<div class="col-lg-4" style="padding: 5px;">
			...
			<span class="lead">Lorem ipsum dolor sit amet, consectetur
				...
				magni recusandae laborum minus inventore?</span>
				</div>
		</div>

		<!-- Blog Sidebar Widgets Column -->
		<div class="col-lg-7 col-sm-7" style="margin-left: 10px;">
			<div style="font-size: 15pt; padding-left:6px; margin-bottom:5px;">도서 현황&nbsp; [8권]</div>
			<table class="table table-striped bookstatus"
				style="border: 1px solid #ddd;" id="section1">
				<thead>
					<tr>
						<th><input type="checkbox" style="float:left;" id="totalck" value="total"/><label for="totalck">도서번호</label></th>
						<th>ISBN</th>
			...
			<div style="font-size: 15pt; padding-left:6px; margin-bottom:5px; margin-top:30px;">예약 현황&nbsp;</div>
			<table class="table table-striped bookstatus"
				style="border: 1px solid #ddd;" id="section1">
				<thead>
					<tr>
