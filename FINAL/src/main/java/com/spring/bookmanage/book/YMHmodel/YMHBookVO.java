...
public class YMHBookVO 
{
	...
	// ===  출판사 테이블용  === //
	private String pubCode; 		// 책소개
	private String name; 		// 책소개
	private String addr; 		// 책소개
	private String tel; 		// 책소개
	...
	public YMHBookVO(String bookId, String title, String author, String pubCode_fk, int ageCode, int ncode_fk,
			...
			String iSBN, String intro, String image, int price, String weight, int totalPage, String pDate,
			String pubCode, String name, String addr, String tel, String filename, String orgFilename, String filesize) 
	{
		this.bookId = bookId;
		this.title = title;
		this.author = author;
